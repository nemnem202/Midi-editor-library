...
export const GRID_ACTIONS = [Action.SET_BPM, Action.SET_SIGNATURE, Action.SET_SUBDIVISION];

export const TACKLIST_ACTIONS = [Action.SET_TRANSPORT_START, Action.SET_TRACKLIST_POSITION];
